// src/app/FullShopwomens/page.tsx (or wherever your Women's catalog is)
...
const Womenscatalog = () => {
  const categories = [
    { title: "Stitched", slug: "stitched", image: "/images/stitched.jpg", items: "24 items" },
    { title: "Unstitched", slug: "unstitched", image: "/images/unstitched.jpg", items: "32 items" },
    { title: "Western", slug: "womens-western", image: "/images/western.png", items: "18 items" }, // Changed slug to "womens-western"
  ];
    ...
    <div className="container mx-auto px-4 py-12 ">
      <div className="text-center mb-12 font-logo">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
         Elevate your wardrobe with our womens collection—blending sophisticated style, vibrant expression, and everyday comfort.
        </p>
      </div>
      ...
      <div className="flex md:grid md:grid-cols-3 gap-6 overflow-x-auto pb-6 md:pb-0 scrollbar-hide">
        {categories.map((cat, index) => (
          ...
          >
            <Link href={`/category/${cat.slug}`}>  {/* Use cat.slug instead of cat.title.toLowerCase() */}
