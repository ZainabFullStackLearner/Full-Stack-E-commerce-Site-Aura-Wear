...
export default function Categories() {
  const categories = [
    { title: "EASTERN", image: "/images/eastern.jpg", items: "24 items" },
    { title: "WESTERN", image: "/images/western.jpg", items: "32 items" },
    { title: "BOTTOM", image: "/images/images.jpg", items: "18 items" },
  ];

  return (
    <div className="container mx-auto px-4 py-12 font-logo">
      <div className="text-center mb-12">
        <h1 className="text-3xl font-bold text-gray-900 mb-3">MENS COLLECTION</h1>
        <p className="text-gray-600 max-w-2xl mx-auto">
          Discover our premium selection of mens fashion, carefully crafted for style and comfort.
        </p>
      </div>
      ...
      <div className="flex md:grid md:grid-cols-3 gap-6 overflow-x-auto pb-6 md:pb-0 scrollbar-hide">
        {categories.map((cat, index) => (
          <div key={index} className="flex-shrink-0 w-80 md:w-full md:flex-shrink">
